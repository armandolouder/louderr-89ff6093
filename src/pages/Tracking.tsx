...
import { 
  ...
  RefreshCw, Copy, CheckCircle, Search, Clock, Globe, Users
} from "lucide-react";
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="relative w-64">
            ...
            <Input
              placeholder="Buscar produto, cliente, estado..."
              value={search}
              ...
              <div key={pv.id} className="flex items-center gap-3 p-2 rounded-lg hover:bg-secondary/30 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground truncate">
                    ...
                    {pv.customer_email && <span className="ml-2">• {pv.customer_email}</span>}
                  </p>
                </div>
