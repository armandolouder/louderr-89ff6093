...
import { ZernioConfig } from "@/components/api/ZernioConfig";
...
export default function Api() {
  ...
  const integrations = [
    ...
    {
      id: "zernio" as IntegrationId,
      name: "Instagram DM",
      description: "DMs do Instagram via Zernio",
  ...
  return (
    <div className="flex h-full bg-background">
      ...
      {activeIntegration === "zernio" && <ZernioConfig />}
    </div>
  );
}
